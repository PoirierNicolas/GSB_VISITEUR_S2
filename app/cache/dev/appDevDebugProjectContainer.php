...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['db1'] = new \PDO('mysql:host=localhost;dbname=gsb', 'root', 'azerty', array(3 => 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'gsb', 'user' => 'root', 'password' => 'azerty', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'gsb');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('gsb');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database.db1.dsn' => 'mysql:host=localhost;dbname=gsb',
            'database.db1.username' => 'root',
            'database.db1.password' => 'azerty',
